-- Converted enemies (jokers) don't stagger
...
function CopActionHurt.init(self, action_desc, common_data)
	...
	local is_converted = logic_data and logic_data.is_converted or brain and brain.converted and brain:converted()

	if is_converted and hurt_type ~= "fatal" and hurt_type ~= "death" then
		return
	end

	return _original_init(self, action_desc, common_data)
end
