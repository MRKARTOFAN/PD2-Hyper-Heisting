Hooks:Add("LocalizationManagerPostInit", "fray_loc", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["fraymenu_staticrecoil"] = "Static Recoil",
		["fraymenu_staticrecoil_help"] = "Disables the automatic recoil compensation, making you have to manually pull down on the mouse to adjust your aim after you stop firing.",
		["fraymenu_holdtofire"] = "HOLD TO FIRE SINGLE-FIRE WEAPONS",
		["fraymenu_holdtofire_help"] = "Allows players to fire single-fire weapons at their maximum firerate by Fire button.",
		...
		["menu_fray_warning"] = "Suppressed enemies retain normal fire rate.\nSuppressed or dodging enemies retain full accuracy.\nSuppression does not force enemies into cover.\nNo enemy suppression resistance cooldown.\nSpawn group reuse delays are 75% shorter.\nCorpse disposal is disabled in stealth.",
		...
		["loading_heister_52"] = "The Steadiness stat of your selected armor tracks how hard your camera shakes when getting hit...but in Fray, that stat is the same for all armors!",
		...
		["loading_gameplay_96"] = "Captain Winters does not show up in Fray! Well, he does! But not really! But kinda! Yeah!",
		...
		["loading_hh_5"] = "In Fray, cloaker kicks can send you FLYING backwards and deal massive damage! Stay away from them!",
		["loading_hh_6"] = "In Fray, special enemies get more dangerous as difficulties increase! Keep a close eye on them!",
		["loading_hh_7"] = "In Fray, the cops are generally more intelligent, get faster, deal slightly more damage, and are more accurate every 2 difficulties, while their group tactics get better every difficulty!",
		...
		["loading_hh_9"] = "In Fray, shotgunners have massive smoke puffs that come out of their gun when they fire, these can help you locate them, and also help you figure out when they can fire again!",	
		...
		["loading_hh_11"] = "Join the Fray Discord! You can find a link to it in the ModWorkshop page!",
		["loading_hh_12"] = "Ninja enemies are particularly hard to dominate, but are very strong when converted into Jokers!",
		["loading_hh_13"] = "In Fray, Heavy SWATs, Maximum Force Responders, and ZEAL Heavy SWATs gain protection from bullet-based instant kills on all difficulties! But only from weapons and ammo types that can't shoot through shields!",
		["loading_hh_14"] = "You can get to the Fray Options through Mod Options in the Options menu!",
		["loading_hh_15"] = "In Fray, getting hit by an enemy melee attack will temporarily stagger you, and cause you to be unable to attack for a few moments!",
		...
		["loading_hh_17"] = "In Fray, Tasers tasing you into incapacitation and getting downed by Cloakers count as actual downs, which can send you into custody! Be careful around them!",
		["loading_hh_18"] = "In Fray, certain throwables can get their ammo back just from pickups by default!",
		["loading_hh_19"] = "In Fray, being out of stamina does not cancel your sprint, but does cause it to be slower, and not apply sprinting-related bonuses or effects!",
		["loading_hh_20"] = "In Fray, a regular sprint consists of sprinting while above 10 stamina! Sprinting with lower stamina than that will cause sprint-related effects to not activate!",
		...
		["loading_hh_32"] = "In Fray, Shotguns deal a minimum of 10% of their damage at a range! SWAT snipers beware!",
		["loading_hh_33"] = "In Fray, when using Shotguns, raising your weapon's Accuracy above 50 grants you increased minimum damage at higher ranges!",
		["loading_hh_34"] = "In Fray, the continuous damage an enemy takes when burning is based on the weapon's damage stat! Both for Flamethrowers, and Dragon's Breath rounds on shotguns!",
		...
		["menu_l_global_value_hyperheist"] = "This is a Fray item!",
		["menu_l_global_value_hyperheisting_desc"] = "This is a Fray item!",		
		
		["fray_options_title"] = "Fray Options",	
		
		["fray_toggle_hhassault_title"] = "Stylish Assault Corner!",
		["fray_toggle_hhassault_desc"] = "Enhances the [POLICE ASSAULT IN PROGRESS] hud area by adding extra flavor! (Such as entirely unique assault text based on the faction you are fighting against!) NOTE: Requires restarting the heist if changed mid-game!",
		
		["fray_toggle_hhskulldiff_title"] = "Hyper Difficulty Names!",
		["fray_toggle_hhskulldiff_desc"] = "Changes the difficulty names to suit Fray's style!",
		
		["fray_toggle_blurzonereduction_title"] = "Less Blurry Blurzones!",
		["fray_toggle_blurzonereduction_desc"] = "Gently reduces the blurring effect of things such as the Cook Off Methlab in order to stop them from getting in the way of gameplay!",
		...
		["fray_toggle_noweirddof_title"] = "Disable Enviromental Depth Of Field!",
		["fray_toggle_noweirddof_desc"] = "Removes the Depth Of Field from backgrounds and the skybox allowing for them to look much clearer! NOTE: Works with the aiming Depth Of Field!",
		
		["fray_toggle_overhaul_player_title"] = "Fray Player-Side Rebalance!",
		["fray_toggle_overhaul_player_desc"] = "Enables the Fray playerside rebalance, paired with a modified version of Gambyt's VIWR mod! Featuring various reworks of existing skills to make the game feel fresh! WARNING: ONLY TAKES EFFECT AFTER FULL GAME RESTART!!!",
		["fray_requires_restart_title"] = "Restart required!",
		["fray_requires_restart_desc"] = "You have made changes to the following settings:\n$SETTINGSLIST\nChanges will take effect on game restart.\nHave a nice day!",
 ...
 if _G.BB or FullSpeedSwarm or Iter or _G.SC or _G.deathvox then
	Hooks:Add("LocalizationManagerPostInit", "FRAY_Incompatible", function(loc)
	LocalizationManager:add_localized_strings({	
...
if InFmenu then
  if InFmenu.settings.rainbowassault == true or InFmenu.settings.sanehp == true or InFmenu.settings.copmiss == true or InFmenu.settings.copfalloff or InFmenu.settings.skulldozersahoy == 2 or InFmenu.settings.skulldozersahoy == 3 then
	Hooks:Add("LocalizationManagerPostInit", "FRAY_IncompatibleIren", function(loc)
	LocalizationManager:add_localized_strings({	
...
if PD2FRAY and PD2FRAY:SkullDiffEnabled() then
	Hooks:Add("LocalizationManagerPostInit", "FRAY_SKULLS", function(loc)
		LocalizationManager:add_localized_strings({			
...
Hooks:Add("LocalizationManagerPostInit", "FRAY_overhaul", function(loc)
	...
	if PD2FRAY and PD2FRAY:IsOverhaulEnabled() then
		LocalizationManager:add_localized_strings({	
			...
			["st_menu_ghost_concealed"] = "Trickster",
			["st_menu_fugitive_undead"] = "Swordmaster",
			["st_menu_fugitive_berserker"] = "Royal Guard",
			["menu_draw_of_the_sword"] = "Draw Of The Sword",
			["menu_draw_of_the_sword_desc"] = "BASIC: ##$basic##\nYour melee weapons receive ##25%## more range.\n\nACE: ##$pro##\nAfter being revived, you knock down all cops within ##4 meters##.",
			["menu_draw_of_the_sword_basic"] = "Draw Of The Sword Basic",
			["menu_placeholder_revenant_t1"] = "Draw Of The Sword",
			["menu_placeholder_revenant_t1_desc"] = "BASIC: ##$basic##\nYour melee weapons receive ##25%## more range.\n\nACE: ##$pro##\nAfter being revived, you knock down all cops within ##4 meters##.",
			["menu_placeholder_revenant_t1_basic"] = "Draw Of The Sword Basic",

			["menu_acupuncture"] = "Acupuncture",
			["menu_acupuncture_desc"] = "BASIC: ##$basic##\nYou swing melee weapons ##100%## faster.\n\nACE: ##$pro##\nYou charge melee weapons ##50%## faster.",
			["menu_acupuncture_basic"] = "Acupuncture Basic",
			["menu_acupuncture_aced"] = "Acupuncture Aced",
			["menu_mentor"] = "Acupuncture",
			["menu_mentor_desc"] = "BASIC: ##$basic##\nYou swing melee weapons ##100%## faster.\n\nACE: ##$pro##\nYou charge melee weapons ##50%## faster.",
			["menu_draw_of_the_sword_aced"] = "Acupuncture Aced",

			["menu_yield_my_flesh"] = "Yield My Flesh",
			["menu_yield_my_flesh_desc"] = "BASIC: ##$basic##\nYou deal up to ##50%## more melee damage based on Health damage taken.\n\nACE: ##$pro##\nYou deal up to ##750%## more melee damage based on Health damage taken.\n\nNOTE: Effect resets after an enemy kill.",
			["menu_yield_my_flesh_basic"] = "Yield My Flesh Basic",
			["menu_yield_my_flesh_aced"] = "Yield My Flesh Aced",

			["menu_surge_of_power"] = "Surge Of Power",
			["menu_surge_of_power_desc"] = "BASIC: ##$basic##\nYou receive ##30%## more health when revived.\n\nACE: ##$pro##\nYou receive ##300%## melee damage for ##5## seconds when revived.",
			["menu_surge_of_power_basic"] = "Surge Of Power Basic",
			["menu_surge_of_power_aced"] = "Surge Of Power Aced",
			
			["menu_vampirism"] = "Vampirism",
			["menu_vampirism_desc"] = "BASIC: ##$basic##\nUpon killing an enemy with melee, regenerate ##3## Health.\n\nACE: ##$pro##\nUpon killing an enemy with melee, regenerate ##6## Health.\n\nMaking a non-melee kill will regenerate ##2## Health.\n\n##The thirst never really leaves.##",
			["menu_vampirism_basic"] = "Vampirism Basic",
			["menu_vampirism_aced"] = "Vampirism Aced",
			["menu_feign_death"] = "Vampirism",
			["menu_feign_death_desc"] = "BASIC: ##$basic##\nUpon killing an enemy with melee, regenerate ##3## Health.\n\nACE: ##$pro##\nUpon killing an enemy with melee, regenerate ##6## Health.\n\nMaking a non-melee kill will regenerate ##2## Health.\n\n##The thirst never really leaves.##",
			
			["menu_claim_their_bones"] = "To Claim Their Bones",
			["menu_claim_their_bones_desc"] = "BASIC: ##$basic##\nYou take ##50%## less damage. Your weapons lose ##25%## of their total ammunition. You deal ##25%## less ranged damage.\n\nACE: ##$pro##\nYou take ##75%## less damage. Your weapons lose ##50%## of their total ammunition. You deal ##50%## less ranged damage.\n\n##No sun has ever risen without a shadow cast.\nSo this shade, too, shall I accept.##",
			["menu_claim_their_bones_basic"] = "To Claim Their Bones Basic",
			["menu_claim_their_bones_aced"] = "To Claim Their Bones Aced",
			...
			["menu_deck2_1_desc"] = "All firearms have a chance to spread panic among your enemies.\n\nPanic will make enemies go into short bursts of uncontrollable fear.",
			["menu_deck2_1_short"] = "All firearms can spread panic among enemies.",
			["menu_deck2_3_desc"] = "You gain ##30%## more health.",
			["menu_deck2_3_short"] = "You gain ##30%## more health.",
			["menu_deck2_5_desc"] = "You gain ##15%## health damage resistance.",
			["menu_deck2_5_short"] = "You gain ##15%## health damage resistance.",
			["menu_deck2_7_desc"] = "You gain an additional ##30%## more health.",
			["menu_deck2_7_short"] = "You gain an additional ##30%## more health.",
			["menu_deck2_9_desc"] = "You regenerate ##1%## health every ##5## seconds. Every kill increases the next heal by ##0.1%##.",
			["menu_deck2_9_short"] = "Regenerate ##1%## health every ##5## seconds. Kills add ##0.1%## to the next heal.",

			["menu_deck3_1_desc"] = "Your armor recovery rate is increased by ##15%##.",
			["menu_deck3_1_short"] = "Your armor recovery rate is increased by ##15%##.",
			["menu_deck3_3_desc"] = "When wearing armor, your movement speed is ##20%## less affected.",
			["menu_deck3_3_short"] = "Armor movement penalties are reduced by ##20%##.",
			["menu_deck3_5_desc"] = "You gain ##15%## more armor.",
			["menu_deck3_5_short"] = "You gain ##15%## more armor.",
			["menu_deck3_7_desc"] = "Your armor recovery is ##50%## less affected by suppression.",
			["menu_deck3_7_short"] = "Suppression slows armor recovery ##50%## less.",
			...
			["menu_deck12_1_desc"] = "Your health is fixed at ##1## and cannot be increased by skills. Your armor cannot be pierced. Cloaker and Taser special attacks damage armor instead of health.",
			["menu_deck12_1_short"] = "Health is fixed at ##1##. Armor blocks piercing, Cloaker, and Taser damage.",
			["menu_deck12_3"] = "Hebi Irezumi",
			["menu_deck12_3_desc"] = "Your movement speed is increased by ##10%##. The effect is doubled below ##50%## remaining armor.",
			["menu_deck12_3_short"] = "Gain ##10%## movement speed, doubled below ##50%## armor.",
			["menu_deck12_5"] = "Elusive",
			["menu_deck12_5_desc"] = "You gain ##15%## damage resistance. The effect is doubled below ##50%## remaining armor.",
			["menu_deck12_5_short"] = "Gain ##15%## damage resistance, doubled below ##50%## armor.",
			["menu_deck12_7"] = "Ryu Irezumi",
			["menu_deck12_7_desc"] = "Your armor recovery speed is increased by ##10%##. The effect is doubled below ##50%## remaining armor.",
			["menu_deck12_7_short"] = "Gain ##10%## armor recovery speed, doubled below ##50%## armor.",
			["menu_deck12_9"] = "Oni Irezumi",
			["menu_deck12_9_desc"] = "When taking lethal damage, you survive the hit and recover your armor. This occurs once every ##360## seconds. Every kill reduces the cooldown by ##1## second.",
			["menu_deck12_9_short"] = "Survive lethal damage and recover armor every ##360## seconds. Kills reduce cooldown by ##1## second.",
			["menu_st_spec_12_desc"] = "Yakuza fights at one health behind unpierceable armor. Low armor boosts movement, damage resistance, and armor recovery.",

			["menu_deck14_1_desc"] = "##100%## of damage you deal becomes Hysteria Stacks, up to ##600## stacks. You gain ##1## damage absorption for every ##75## stacks. Hysteria decays after receiving damage.",
			["menu_deck14_1_short"] = "Damage becomes Hysteria, up to ##600##. Every ##75## stacks grants ##1## damage absorption.",
			["menu_deck14_5_desc"] = "Hysteria decay is delayed by ##0.5## seconds after receiving damage.",
			["menu_deck14_5_short"] = "Damage delays Hysteria decay by ##0.5## seconds.",
			["menu_deck14_9_desc"] = "Hysteria decay is delayed by an additional ##0.1## seconds for each enemy targeting you.",
			["menu_deck14_9_short"] = "Each enemy targeting you delays Hysteria decay by ##0.1## seconds.",

			["menu_deck16_1_desc"] = "Each enemy kill restores ##5## health and ##5## armor. After four rewards, this effect has a ##4## second cooldown.",
			["menu_deck16_1_short"] = "Kills restore ##5## health and armor. Four rewards trigger a ##4## second cooldown.",
			["menu_deck16_3_desc"] = "For every ##10%## health missing, your dodge chance increases by ##1%##.",
			["menu_deck16_3_short"] = "Gain ##1%## dodge per ##10%## missing health.",
			["menu_deck16_5_desc"] = "For every ##10%## health missing, the kill-reward cooldown is reduced by ##0.1## seconds.",
			["menu_deck16_5_short"] = "Reduce kill-reward cooldown by ##0.1## seconds per ##10%## missing health.",
			["menu_deck16_7_desc"] = "For every ##10%## armor missing, your dodge chance increases by ##1%##.",
			["menu_deck16_7_short"] = "Gain ##1%## dodge per ##10%## missing armor.",
			["menu_deck16_9_desc"] = "For every ##10%## armor missing, the kill-reward cooldown is reduced by ##0.1## seconds. Combined cooldown cannot be shorter than ##2## seconds.",
			["menu_deck16_9_short"] = "Missing armor further reduces kill-reward cooldown, to a combined minimum of ##2## seconds.",
		})
	end
