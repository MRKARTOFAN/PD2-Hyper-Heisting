...
Hooks:PostHook(GenericUserManager, "setup_setting_map", "fray_init", function(self)
...
Hooks:PostHook(GenericUserManager, "reset_controls_setting_map", "FRAY_reset_controls_setting_map", function(self)
...
Hooks:PostHook(GenericUserManager, "sanitize_settings", "FRAY_sanitize_settings", function(self)
